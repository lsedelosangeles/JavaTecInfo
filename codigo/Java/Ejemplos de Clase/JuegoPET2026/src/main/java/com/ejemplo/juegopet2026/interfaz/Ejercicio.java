...
public class Ejercicio extends JFrame {
    ...
    private void configurar() {
        ...
        pnlCuadricula = new JPanel( new GridLayout(cuadros, cuadros) );
        pnlCuadricula.setPreferredSize(new Dimension(dimTablero, dimTablero));//Size(5200, 5200);
